...
const InstallPromptIcon = () => {
  ...
  return (
    <div
      ...
      className="flex md:flex-col items-center w-full p-2 rounded-md hover:bg-slate-200 dark:hover:bg-slate-700 transition-transform duration-200 ease-in-out group cursor-pointer"
    >
