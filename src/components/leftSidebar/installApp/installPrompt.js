...
const InstallPromptIcon = () => {
  ...
  return (
    <div
      ...
      className="flex flex-col items-center w-full p-2 rounded-md hover:bg-slate-200 dark:hover:bg-slate-700 hover:scale-105 transition-transform duration-200 ease-in-out group cursor-pointer"
    >
