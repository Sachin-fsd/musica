                ...
                {data.map((artist) => {
                    ...
                    return (
                        <div
                            ...
                            role="button"
                            tabIndex={0}
                            className="group flex flex-col items-center gap-3 p-3 -m-3 rounded-xl sm:hover:bg-secondary/40 transition-colors duration-300 ease-out cursor-pointer focus:outline-none focus-visible:ring-2 focus-visible:ring-primary"
                        >
                            ...
                            <div className="flex flex-col items-center text-center min-w-0 w-full px-1">
                                <h4 className="text-base font-semibold truncate w-full text-foreground sm:group-hover:text-primary transition-colors">
