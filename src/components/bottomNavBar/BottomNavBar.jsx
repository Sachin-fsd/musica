...
const BottomNavBar = () => {
    ...
    return (
        <nav className=" z-50 w-full bg-gradient-to-r from-[#181c2f] via-[#1a223f] to-[#181c2f] rounded-2xl shadow-xl border border-white/10 px-4 py-2 flex items-center justify-between backdrop-blur-md m-auto">
